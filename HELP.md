...
* The original package name 'com.fluxocaixacontrol.fluxo-caixa-control' is invalid and this project uses 'com.fluxocaixacontrol.fluxo_caixa_control' instead.
...
* [Spring Batch](https://docs.spring.io/spring-boot/4.1.0-SNAPSHOT/how-to/batch.html)
